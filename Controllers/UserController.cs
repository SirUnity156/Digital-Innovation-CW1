...
namespace DigitalInnovationCW1.Controllers
{
    public class UserController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Username,HashedPassword,IsDarkMode")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Username,HashedPassword,IsDarkMode")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
